...
(function(BS) {
	...
	BS.Turn.prototype = {
		createItem: function(d) {
			...
			if ($.browser.msie) {
				item.imgCon = $('<div class="imgCon"><img src=' + d.img + ' width="150" height="150" alt=' + d.title + '><div class="imgDis">' + d.descript + '</div></div>').appendTo(item.animate);
			} else {
				...
				item.descript = $('<div><p style="padding:10px;">' + d.descript + '</p></div>').css({
